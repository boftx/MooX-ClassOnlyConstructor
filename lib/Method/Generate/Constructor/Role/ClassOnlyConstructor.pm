...
use B ();
{
  $Method::Generate::Constructor::Role::ClassOnlyConstructor::VERSION = '0.006';
}
...
This role effectively replaces L<Method::Generate::Constructor/_generate_prolog>
with code that C<die>s if C<$class> is a reference.
